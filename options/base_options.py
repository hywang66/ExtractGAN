...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input_size', type=int, default=224, help='224 is the standard input size to VGG16')
        ...
        parser.add_argument('--batch_size_d', type=int, default=10, help='input batch size')
